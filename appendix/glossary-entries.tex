...
\newglossaryentry{wslg}{
    ...
    sort=wsl,
    description={\emph{Windows Subsystem for Linux} è un livello di compatibilità sviluppato da Microsoft che permette di eseguire un ambiente GNU/Linux nativo direttamente in Windows, senza ricorrere a macchine virtuali tradizionali o configurazioni \emph{dual-boot}.}
}

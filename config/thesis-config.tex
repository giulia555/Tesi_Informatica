...
\addtocategory{web}{site:awesome-data-catalogs}
\addtocategory{web}{site:adventureworks}
\addtocategory{web}{site:openmetadata-docs}
\addtocategory{web}{site:openmetadata-repo}
\addtocategory{web}{site:gdpr}
\addtocategory{report}{dama:dq-dimensions}
\addtocategory{web}{site:agid-linee-guida}
\addtocategory{web}{site:ibm_data_quality}
\addtocategory{web}{ite:business-intelligence}
\addtocategory{web}{site:powerbi-docs}
\addtocategory{web}{site:fides}
\addtocategory{web}{site:bytebase}
\addtocategory{web}{site:hawk-eye}
\addtocategory{web}{ite:arx}
\addtocategory{web}{site:presidio}
